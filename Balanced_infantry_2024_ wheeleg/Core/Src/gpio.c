...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, RS485_RE_Pin|GPIO_PIN_11|RS485_DE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PEPin PE11 PEPin */
  GPIO_InitStruct.Pin = RS485_RE_Pin|GPIO_PIN_11|RS485_DE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
