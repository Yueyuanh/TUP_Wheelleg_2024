...
/* ----------------------- PC Key Definition-------------------------------- */
#define    RC_CH0_RLR_OFFSET    (rc_ctrl.rc.ch0 - RC_CH_VALUE_OFFSET)
#define    RC_CH1_RUD_OFFSET  	(rc_ctrl.rc.ch1 - RC_CH_VALUE_OFFSET)
#define    RC_CH2_LLR_OFFSET  	(rc_ctrl.rc.ch2 - RC_CH_VALUE_OFFSET)
